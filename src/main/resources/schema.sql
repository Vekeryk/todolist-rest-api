create sequence task_seq start with 10 increment by 50;
create sequence todo_seq start with 10 increment by 50;
...
create table tasks (id bigint not null, name varchar(200) not null, priority varchar(255), state_id bigint, todo_id bigint, primary key (id));
create table todo_collaborator (collaborator_id bigint not null, todo_id bigint not null);
create table todos (id bigint not null, created_at timestamp not null, title varchar(255) not null, owner_id bigint, primary key (id));
create table users (id bigint not null, email varchar(255) not null, first_name varchar(255) not null, last_name varchar(255) not null, password varchar(255) not null, role_id bigint, primary key (id));
